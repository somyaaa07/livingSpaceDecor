      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <p className="text-[9px] md:text-[10px] uppercase tracking-[.3em] text-[#D4AF37] font-semibold">
          ...
          <h2 className="font-[Cormorant_Garamond,serif] text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white leading-[1.15] mb-4 md:mb-5">
            ...
            <br />
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#E8B84A]">
              with Confidence
            </span>
          </h2>
          <p className="text-sm md:text-base text-white/75 max-w-2xl mx-auto leading-relaxed">
            4 simple questions. One personalized estimate. Discover what your
            perfect space costs.
          </p>
        </motion.div>
              ...
              {progressSteps.map((s, idx) => (
                <div key={s.num} className="flex items-center gap-1.5 sm:gap-3">
                  ...
                  {idx < progressSteps.length - 1 && (
                    <div
                      className={`hidden sm:block w-8 h-0.5 mx-1 transition-colors ${
            ...
            <div className="p-5 md:p-6 rounded-2xl bg-gradient-to-r from-[#C8972B]/8 to-[#8B6B4A]/8 border border-[#C8972B]/25 backdrop-blur-sm">
              <div className="flex gap-3 md:gap-4">
                <div className="flex-shrink-0 mt-0.5">
                  <div className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-[#C8972B] flex items-center justify-center text-white text-xs font-bold">
                    ✓
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-xs text-white/60 leading-relaxed">
                    Get your personalized estimate instantly. Our design
                    specialist will contact you within 24 hours to discuss your
                    vision and refine the budget.
                  </p>
                </div>
              </div>
            </div>
